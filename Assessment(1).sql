...
Foreign Key (CustomerID) References CustomersDIG(CustomerID)
);
...
Foreign key (OrderID) References OrdersDIG(OrderID),
Foreign Key (ProductID) References ProductsDIG(ProductID)
);
...
INSERT INTO ProductsDIG (ProductID, Name, Category, Price) VALUES
...
INSERT INTO OrdersDIG (OrderID, CustomerID, Orderdate, Totalamount) VALUES
